...
function Debug(offset) {
    return (...args) => {
        const [type, subType] = [
            source.redBright(offset.split(":").slice(0, 1).pop()),
            source.red(offset.split(":").slice(1).join(":")),
        ];
...
let debug$1 = Debug("markdown:slot-tokens");
...
const debug$3 = Debug("markdown:start-block");
...
let debug$4 = Debug("markdown:htmlBlock");
/**
 * **htmlBlock**
 *
